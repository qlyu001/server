...
/*recognize this map and get the code ,and transform it to the format we need. */

public class VectorProjectWholeFile {
	...
	class ExportShapefileAction extends SafeAction {
		  private void exportToShapefile() throws Exception {
		      ...
		      //  CoordinateReferenceSystem worldCRS = CRS.decode(code)
   ...
   private void displayShapefile() throws Exception {
       sourceFile = JFileDataStoreChooser.showOpenFile("usa_counties.shp", null);
        if (sourceFile == null) {
            return;
        }
...
//		FileDataStore store = FileDataStoreFinder.getDataStore(file);
    ...
    public static void main(String[] args) throws Exception {
        VectorProjectWholeFile lab = new VectorProjectWholeFile();
