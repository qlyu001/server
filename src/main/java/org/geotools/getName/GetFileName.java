...
{	static String dirPath="/home/qlyu001/workspace/server/";
	public static String vectorfilepath=dirPath+"src/main/webapp/vectorfilelist.txt";
	public static String vectorfoldpath=dirPath+"vectorfile";	
	public static String rasterfilepath=dirPath+"src/main/webapp/rasterfilelist.txt";
