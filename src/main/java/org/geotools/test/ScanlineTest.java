...
import org.geotools.function.GetEnvolope;
import org.geotools.function.Getgeom;
import org.geotools.function.RVConversion2;
import org.geotools.function.Rounding;
...
public class ScanlineTest {
	public static void scanlineTest(String countryname,String path,String placeKey) throws CQLException, IOException{
		...
		Vector<Coordinate> pionts_inside_geom = getpoints(allpolygons);
